...
*Only the 15 most relevant rows are shown.*
*Price is the latest daily close. SMA50/SMA200 are simple moving averages of the last 50/200 daily closes (each shown only when at least that many bars are available; the 6-month history used here is ~130 bars, so vs SMA200 can be n/a). '3m vs SPY' is the ETF's 3-month return minus SPY's over the same window, in points.*
---
